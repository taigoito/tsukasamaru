...
$site_top = "https://tsukasamaruyado.com/";

//管理者のメールアドレス ※複数指定する場合は「,」で区切る 例 $to = "aa@aa.aa,bb@bb.bb";
$to = "welcome@tsukasamaruyado.com";

//送信元メールアドレス ※設置先サイトと同じドメイン推奨
$from = "welcome@tsukasamaruyado.com";
...
$Referer_check = 1;
$Referer_check_domain = "tsukasamaruyado.com";
...
$jumpPage = 0;
$thanksPage = "https://tsukasamaruyado.com/thanks.html";
